import { getAdminWithdrawals, approveWithdrawal, rejectWithdrawal, WithdrawalResponse } from '@/services/transaction';
                                ...
                                <AlertDialogContent className='dark border border-gray-700'>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      ...
                                      <span className='font-semibold text-green-500'>{withdrawal.userName}</span>? This
                                      action will release funds to the user's UPI ID:{' '}
                                ...
                                <AlertDialogContent className='dark border border-gray-700'>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      ...
                                      <span className='font-semibold text-rose-500'>{withdrawal.userName}</span>? Please
