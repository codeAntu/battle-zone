  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-black p-4'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        <div className='absolute top-1/3 left-1/3 h-96 w-96 animate-pulse rounded-full bg-blue-500/5 blur-3xl'></div>
        <div className='absolute right-1/3 bottom-1/3 h-96 w-96 animate-pulse rounded-full bg-indigo-500/5 blur-3xl delay-1000'></div>
      </div>
      ...
      <Card className='relative w-full max-w-md border border-gray-700/50 bg-gray-900/80 shadow-2xl backdrop-blur-sm'>
        <CardHeader className='flex flex-col items-center gap-y-4 pb-6'>
          {' '}
          {/* User Badge */}
          <div className='inline-flex items-center gap-2 rounded-full border border-blue-500/25 bg-blue-500/15 px-3 py-1.5 text-sm font-medium text-blue-400'>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                <Input
                  ...
                  className='border-gray-700/50 bg-gray-800/50 pl-10 text-white transition-all duration-200 placeholder:text-gray-500 focus:border-blue-500 focus:ring-blue-500/20'
                />
                <svg
              ...
              <div className='space-y-2'>
                ...
                >
                  <InputOTPGroup className='flex w-full justify-center gap-2'>
                    <InputOTPSlot
                      index={0}
                      className='h-12 w-12 border-gray-700/50 bg-gray-800/50 text-lg font-semibold text-white focus:border-blue-500 focus:ring-blue-500/20'
                    />
                    <InputOTPSlot
                      index={1}
                      className='h-12 w-12 border-gray-700/50 bg-gray-800/50 text-lg font-semibold text-white focus:border-blue-500 focus:ring-blue-500/20'
        ...
        <CardFooter className='px-6 pb-6'>
          <div className='grid w-full gap-y-4'>
            <Button
              className='h-12 transform rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 font-semibold text-white shadow-lg transition-all duration-200 hover:scale-[1.02] hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl'
            ...
            >
              {isLoginPending || isRegisterPending ? (
                <div className='flex items-center gap-3'>
                  ...
                  <span>{isVerify ? 'Verifying Account...' : isSignUp ? 'Creating Account...' : 'Signing In...'}</span>
                </div>
              ) : (
              ...
              <div className='flex justify-center'>
                ...
                {isSignUp ? (
                  ...
                  >
                    ...
                    <span className='ml-1 text-blue-400 underline hover:text-blue-300'>Sign In</span>
                  </Button>
                ) : (
                  <Button
                    variant='link'
                  ...
                  >
                    ...
                    <span className='ml-1 text-blue-400 underline hover:text-blue-300'>Create Account</span>
                  </Button>
                )}
              </div>
            )}
            ...
            <div className='border-t border-gray-700/50 pt-4'>
              <Button
                ...
                className='w-full text-purple-400 transition-colors duration-200 hover:text-purple-300'
              >
